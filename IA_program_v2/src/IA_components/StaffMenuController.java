...
public class StaffMenuController implements Initializable{
   // public static int TransferKey=0;
    ...
    public void Staff_product (ActionEvent actionEvent) throws IOException {
    ...
    public void Staff_productSum (ActionEvent actionEvent) throws IOException {
        Stage stage = (Stage) M_PRbutton.getScene().getWindow();
        stage.close();
        Stage primaryStage = new Stage();
    ...
    public void Staff_receipt (ActionEvent actionEvent) throws IOException {
        Stage stage = (Stage) M_PRbutton.getScene().getWindow();
        stage.close();
        Stage primaryStage = new Stage();
    ...
    public void Staff_logout (ActionEvent actionEvent) throws IOException {
    ...
    public void Queries(int userKey) throws SQLException{
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        int userKey=LoginController.getUser();
